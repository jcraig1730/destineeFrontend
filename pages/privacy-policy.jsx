...
const PrivacyPolicy = () => {
  ...
  return (
    <div>
      <h1>Privacy Policy for Destinee's Site</h1>

      <p>
        At Destinee's Site, accessible from destinee-frontend.vercel.app, one of
        ...
        Destinee's Site and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Destinee's Site. This policy is not applicable
      ...
      <p>
        Destinee's Site follows a standard procedure of using log files. These
      ...
      <p>
        Like any other website, Destinee's Site uses 'cookies'. These cookies
      ...
      <p>
        ...
        advertising partners of Destinee's Site.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Destinee's Site, which are sent
      ...
      <p>
        Note that Destinee's Site has no access to or control over these cookies
      ...
      <p>
        Destinee's Site's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Destinee's Site does not knowingly collect any Personal Identifiable
